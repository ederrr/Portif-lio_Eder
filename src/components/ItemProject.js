		...
		if(isMobile){
			return (
				<div className="w-50 d-inline-block px-1 align-top">
					<img className= "img-fluid rounded w-100 rounded border border-dark " src={`https://raw.githubusercontent.com/ederrr/${this.props.name}/master/image_default.jpg`} alt="project"></img>
